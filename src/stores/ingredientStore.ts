...
const createStore = () => {
  const ingridients: Ingredient[] = [
    ...
    { id: 3, name: 'Листья златолистника', element: new Vermilion(), state: AlchemicState.Albedo | AlchemicState.Rubedo },
    ...
    { id: 11, name: 'Цветы двустрела', element: new Hydragenum(), state: AlchemicState.Albedo | AlchemicState.Nigredo },
    { id: 12, name: 'Цветы переступня', element: new Caelum(), state: AlchemicState.Rubedo },
    { id: 13, name: 'Листья ласточкиного зелья', element: new Rebis(), state: AlchemicState.Nigredo | AlchemicState.Albedo },
    ...
    { id: 19, name: 'Корень дьявольника', element: new Quebrith(), state: AlchemicState.Albedo | AlchemicState.Rubedo }, // Квебрит + купорос
    { id: 20, name: 'Цветы горицвета', element: new Aether(), state: AlchemicState.Albedo }, // Эфир + ребис
    { id: 21, name: 'Нераскрывщийся бутон алоглазика', element: new Rebis(), state: AlchemicState.Albedo | AlchemicState.Nigredo }, // Ребис + солон
    { id: 22, name: 'Листья подорожника', element: new Rebis(), state: AlchemicState.Albedo | AlchemicState.Rubedo }, // Ребис + ребис
    { id: 23, name: 'Живица живого дерева', element: new Rebis(), state: AlchemicState.Albedo | AlchemicState.Rubedo }, // Ребис + эфир
    { id: 24, name: 'Шишки ели сребряной', element: new Quebrith(), state: AlchemicState.Nigredo | AlchemicState.Albedo | AlchemicState.Rubedo },
    { id: 25, name: 'Багульник', element: new Rebis(), state: AlchemicState.Albedo | AlchemicState.Rubedo },
    { id: 27, name: 'Пыльца дивносонника', element: new Aether(), state: AlchemicState.Albedo | AlchemicState.Rubedo }, // Эфир + аэр
    { id: 28, name: 'Корень мертвоцвета', element: new Vermilion(), state: AlchemicState.Albedo | AlchemicState.Rubedo },
    ...
    { id: 31, name: 'Цветы чемерицы', element: new Hydragenum(), state: AlchemicState.Albedo | AlchemicState.Rubedo },
    { id: 32, name: 'Шляпка волчьего зонтика', element: new Hydragenum(), state: AlchemicState.Rubedo }, // Гидроген + купорос
    { id: 34, name: 'Синий мох', element: new Vitriol(), state: AlchemicState.Albedo | AlchemicState.Rubedo },
    ...
    { id: 42, name: 'Остролист', element: new Quebrith(), state: AlchemicState.Albedo | AlchemicState.Rubedo },// Квебрит + аэр
